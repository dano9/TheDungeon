...
public class PlayerCamera : MonoBehaviour
{
    ...
    public void GoToPassage(Passage passage)
    {
        ...
        if (curCamCoord != null) { currentBounds = curCamCoord.bounds; LightingManager.main.AssignLightingCoordination(curCamCoord.lightingCoordination,true); }//curColor=curCamCoord.bgColor;}
    }
    public void SwitchCamCoord(CamCoordinator newCamCoord)
    {
        curCamCoord = newCamCoord;
        LightingManager.main.AssignLightingCoordination(curCamCoord.lightingCoordination);
    }
}
